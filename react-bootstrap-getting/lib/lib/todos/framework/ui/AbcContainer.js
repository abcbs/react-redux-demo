...
var AbcContainer = function (_Component) {
    _inherits(AbcContainer, _Component);

    function AbcContainer() {
        _classCallCheck(this, AbcContainer);

        return _possibleConstructorReturn(this, (AbcContainer.__proto__ || Object.getPrototypeOf(AbcContainer)).apply(this, arguments));
    }

    _createClass(AbcContainer, [{
        key: 'render',
        value: function render() {
            ...
            var others = _objectWithoutProperties(_props, ['children', 'isMovedTop', 'isContainer']);

            return _react2.default.createElement(
                'div',
                _extends({}, others, { className: (0, _classnames2.default)({
