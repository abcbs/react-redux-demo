...
var MainBaseTheme = function (_React$Component) {
    _inherits(MainBaseTheme, _React$Component);

    function MainBaseTheme() {
        _classCallCheck(this, MainBaseTheme);

        return _possibleConstructorReturn(this, (MainBaseTheme.__proto__ || Object.getPrototypeOf(MainBaseTheme)).apply(this, arguments));
    }

    _createClass(MainBaseTheme, [{
        key: 'getChildContext',
