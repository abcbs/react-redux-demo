var JS = {version: '0.0.2'};
JS.Runtime = (function () {
    var ua = navigator.userAgent.toLowerCase(), check = function (r) {
        return r.test(ua);
    }, isOpera = check(/opera/), isFirefox = check(/firefox/), isChrome = check(/chrome/),
        ...
        isIE7 = isIE && check(/msie 7/), isIE8 = isIE && check(/msie 8/), isIE6 = isIE && !isIE7 && !isIE8,
        isGecko = !isWebKit && check(/gecko/), isGecko2 = isGecko && check(/rv:1\.8/),
        isGecko3 = isGecko && check(/rv:1\.9/), isWindows = check(/windows|win32/),
...
JS.Event.prototype = {
    fire: function () {
        var
            listeners = this.listeners, i = listeners.length - 1;
        for (; i > -1; i--) {
...
JS.AJAX = (function () {
    ...
    return {
        dataFormatError: '服务器返回的数据格式有误', urlError: '未指定url', post: function (url, param, callback, scope, asyn) {
...
JS.Connector = JS.extend(JS.Observable, {
    ...
    constructor: function () {
        ...
        if (JS.isIE7) {
            this._xhr = new JS.XMLHttpRequest({specialXHR: 'Msxml2.XMLHTTP.6.0'});
        } else {
...
JS.Engine = (function () {
    var Engine = JS.extend(JS.Observable, {
        lStore: [], running: false, connector: null, constructor: function () {
            ...
            if (this.running) {
                ...
                this.lStore.push({eventName: eventName, fn: fn, scope: scope, o: o});
            }
        }, initEvent: function () {
            var self = this;
            this.connector.on({
