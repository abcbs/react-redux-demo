...
var allPromise = Q.all([fs_readFile('index.html'), fs_readFile('applycall.html')]);
...
function readFile(previous, fileName) {
  return Q.promise(function (resolve, reject) {
    fs.readFile(path.join(process.cwd(), fileName), function (error, text) {
      if (error) {
...
readFile('', 'index.html').then(function (previous) {
