		...
		(
			<div>
				...
				<div style={style.container}>
					<p>This is an example of REST API usage with no database persistence
						(Javascript is required for this particular example)</p>
		...
		if (users.is_empty())
		{
			...
			(
				<div style={style.users}>
					...
					<Button action={this.add_user} 
							style={style.users.add}>Add user</Button>

					<Button action={this.refresh} 
							busy={this.state.refreshing} 
							style={style.users.refresh}>Refresh</Button>
				</div>
			)
